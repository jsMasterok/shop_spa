        ...
        <div className="h-fit w-full p-2 border border-slate-100 grid grid-cols-12 gap-y-3">
          <div className="col-span-12">
            <span
              onClick={() => {
                copy(orderId).then(() =>
                  toast.success("Номер замовлення успішно зкопійований")
                );
              }}
              className=" text-center w-full flex items-center justify-center mb-2 text-sm font-semibold text-slate-400 underline cursor-pointer"
            >
